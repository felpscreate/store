document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderAll() {
        ...
        siteData.produtos.forEach((prod, pIndex) => renderProduct(prod, pIndex));
    }

    function renderProduct(prod, pIndex) {
        ...
        vBtnAdd.addEventListener('click', () => {
            ...
            siteData.produtos[pIndex].versoes.push({
                titulo: "", specs: "", preco: "", imagens: ["", "", ""]
            });
            renderAll();
        });

        productsContainer.appendChild(prodNode);
    }
