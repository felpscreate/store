            ...
            slide.innerHTML = `
                ...
                <div class="modal-text">
                    ...
                    <div style="margin-top: 24px;">
                        <a href="https://api.whatsapp.com/send?phone=555185729132&text=${encodeURIComponent(zapFallback)}" class="btn btn-buy cta-btn" style="padding: 16px 32px;" target="_blank" rel="noopener noreferrer">
                             Falar no WhatsApp
                        </a>
                    </div>
                </div>
